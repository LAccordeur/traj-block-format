...
static const int LBA_COUNT_OFFSET = LAT_MAX_OFFSET + LAT_MAX_SIZE;
...
int calculate_isp_descriptor_space(struct isp_descriptor *descriptor) {
    int size = ISP_TYPE_SIZE + OID_SIZE + TIME_MIN_SIZE + TIME_MAX_SIZE + LON_MIN_SIZE + LON_MAX_SIZE + LAT_MIN_SIZE + LAT_MAX_SIZE  + LBA_COUNT_SIZE +
