...
void parse_geolife_row(char* line, struct traj_point *destination_row) {
...
int read_points_from_csv_geolife(FILE *fp, struct traj_point **points, int row_offset, int row_count)  {
    long int file_offset = (long int) row_offset * GEOLIFE_CSV_ROW_SIZE;
